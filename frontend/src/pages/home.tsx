    ...
    <>
      ...
      <div className="relative w-full h-[600vh]">
        <div className="absolute top-0 left-0 w-full h-full">
          <div className="h-[100vh] w-full bg-[#22223B]"></div>
          <div className="h-[180vh] w-full bg-[#F2E9E4]"></div>
          <div className="h-[120vh] w-full bg-[#22223B]"></div>
          <div className="h-[200vh] w-full bg-[#F2E9E4]"></div>
        </div>

        <div className="absolute top-8 left-8 transform bg-[#22223B] text-[#F2E9E4] max-w-3xl p-8 pt-16 shadow-lg rounded-lg">
          ...
          <div className="mt-4">
            <button className="bg-[#F2E9E4] text-[#22223B] font-semibold px-6 py-3 rounded-lg hover:bg-[#e3d7cf] hover:text-[#22223B] focus:outline-none focus:ring-2 focus:ring-[#e3d7cf] focus:ring-offset-2 transition-all duration-300 ease-in-out transform hover:scale-105">
              Start a blog
            </button>
          </div>
        </div>
        ...
        <div className="absolute top-[140vh] left-8 transform bg-[#F2E9E4] text-[#22223B] max-w-3xl p-8 mt-4 pt-4 rounded-lg">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Simple, meet flexible</h1>
          <p className="text-lg md:text-xl text-[#22223B] mb-8">
          ...
          <div className="mt-4">
            <button className="bg-[#22223B] text-[#F2E9E4] font-semibold px-6 py-4 rounded-lg hover:bg-[#3a3a50] hover:text-[#e3d7cf] focus:outline-none focus:ring-2 focus:ring-[#e3d7cf] focus:ring-offset-2 transition-all duration-300 ease-in-out transform hover:scale-105">
              Start a blog
            </button>
          </div>
        </div>
            ...
            {["Blog beautifully", "Edit easily", "Share anything and everything, simply"].map((title, index) => (
              <div key={index}>
                <div className="flex items-center cursor-pointer" onClick={() => handleToggle(index + 1)}>
                  <div className="w-3 h-3 rounded-full bg-[#22223B] mr-4 flex-shrink-0"></div>
                  <span className="text-[#22223B] font-medium text-2xl">{title}</span>
                  <BsArrowDownShort className="ml-auto text-[#22223B]" />
                </div>
                {activeIndex === index + 1 && (
                  <div className="mt-2 text-[#22223B]">
                    <p>
                      {index === 0
        ...
        <div className="absolute top-[290vh] left-8 transform bg-[#22223B] text-[#F2E9E4] max-w-3xl p-8 pt-4 shadow-lg rounded-lg">
      ...
      <div className="absolute top-[440vh] left-8 transform bg-[#F2E9E4] text-[#22223B] max-w-3xl p-8 pt-28 rounded-lg">
        ...
        <div className="mt-4">
          <button className="bg-[#22223B] text-[#F2E9E4] font-semibold px-6 py-3 rounded-lg hover:bg-[#3a3a50] hover:text-[#e3d7cf] focus:outline-none focus:ring-2 focus:ring-[#e3d7cf] focus:ring-offset-2 transition-all duration-300 ease-in-out transform hover:scale-105">
            Join the Conversation
          </button>
        </div>
      </div>

      <div className="absolute top-[500vh] flex justify-center items-center w-full h-screen bg-[#F2E9E4]">
        <ReviewsCarousel />
      </div>

      <div className="bg-sky-600 py-16 px-8 flex justify-center items-center h-[70vh]">
        <div className="text-left max-w-lg text-[#F2E9E4] ml-80 pl-36">
          ...
          <div className="text-left">
            <button className="bg-[#F2E9E4] text-sky-600 font-semibold px-6 py-3 rounded-lg hover:bg-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all duration-300 ease-in-out transform hover:scale-105">
              Start a blog
            </button>
          </div>
        </div>
